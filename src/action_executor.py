...
class ActionExecutor:
    ...
    def __call__(self, action: ProposedAction) -> tuple[bool, str, list[str]]:
        ...
        observation = f"returncode={result.returncode}; stdout={result.stdout[-2000:]}; stderr={result.stderr[-2000:]}"
        return result.success, observation, [observation] if result.success else []
